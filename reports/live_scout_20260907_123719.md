...
- Qwen/Qwen3-0.6B (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB, assessment=NEEDS_DATA) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
...
- trl-internal-testing/tiny-Qwen2ForCausalLM-2.5 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB, assessment=NEEDS_DATA) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- Comfy-Org/stable-diffusion-v1-5-archive (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB, assessment=NEEDS_DATA) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- openai-community/gpt2 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB, assessment=NEEDS_DATA) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
...
- Qwen/Qwen3-0.6B (huggingface, EXTERNAL, not assessed, VRAM=None GB, assessment=NEEDS_DATA)
- Comfy-Org/MiniMax-H3 (huggingface, EXTERNAL, not assessed, VRAM=None GB, assessment=NEEDS_DATA)
- trl-internal-testing/tiny-Qwen2ForCausalLM-2.5 (huggingface, EXTERNAL, not assessed, VRAM=None GB, assessment=NEEDS_DATA)
- Comfy-Org/stable-diffusion-v1-5-archive (huggingface, EXTERNAL, not assessed, VRAM=None GB, assessment=NEEDS_DATA)
- openai-community/gpt2 (huggingface, EXTERNAL, not assessed, VRAM=None GB, assessment=NEEDS_DATA)
...
- Qwen/Qwen3-0.6B vs gpt-oss:20b: delta=not assessed (needs_data)
- Comfy-Org/MiniMax-H3 vs gpt-oss:20b: delta=not assessed (needs_data)
- trl-internal-testing/tiny-Qwen2ForCausalLM-2.5 vs gpt-oss:20b: delta=not assessed (needs_data)
- Comfy-Org/stable-diffusion-v1-5-archive vs gpt-oss:20b: delta=not assessed (needs_data)
- openai-community/gpt2 vs gpt-oss:20b: delta=not assessed (needs_data)