...
- sentence-transformers/all-MiniLM-L6-v2 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- cross-encoder/ms-marco-MiniLM-L6-v2 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- BAAI/bge-small-en-v1.5 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
...
- google-bert/bert-base-uncased (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- BAAI/bge-m3 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- amazon/chronos-2 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- sentence-transformers/all-mpnet-base-v2 (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
- google-t5/t5-small (score=not assessed, tier=EXTERNAL, source=huggingface, VRAM=None GB) Reason: NEEDS_DATA: quality benchmark data is not assessed; hardware tier EXTERNAL, VRAM estimate unavailable.
...
- sentence-transformers/all-MiniLM-L6-v2 (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- cross-encoder/ms-marco-MiniLM-L6-v2 (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- BAAI/bge-small-en-v1.5 (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- google/electra-base-discriminator (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- google-bert/bert-base-uncased (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- BAAI/bge-m3 (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- amazon/chronos-2 (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- sentence-transformers/all-mpnet-base-v2 (huggingface, EXTERNAL, not assessed, VRAM=None GB)
- google-t5/t5-small (huggingface, EXTERNAL, not assessed, VRAM=None GB)
...
- sentence-transformers/all-MiniLM-L6-v2 vs gpt-oss:20b: delta=not assessed (needs_data)
- cross-encoder/ms-marco-MiniLM-L6-v2 vs gpt-oss:20b: delta=not assessed (needs_data)
- BAAI/bge-small-en-v1.5 vs gpt-oss:20b: delta=not assessed (needs_data)
- google/electra-base-discriminator vs gpt-oss:20b: delta=not assessed (needs_data)
- google-bert/bert-base-uncased vs gpt-oss:20b: delta=not assessed (needs_data)
- sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 vs gpt-oss:20b: delta=not assessed (needs_data)
- BAAI/bge-m3 vs gpt-oss:20b: delta=not assessed (needs_data)
- amazon/chronos-2 vs gpt-oss:20b: delta=not assessed (needs_data)
- sentence-transformers/all-mpnet-base-v2 vs gpt-oss:20b: delta=not assessed (needs_data)
- google-t5/t5-small vs gpt-oss:20b: delta=not assessed (needs_data)